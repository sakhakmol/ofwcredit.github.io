...
!function(a) {
  ...
  b.prototype = {
          ...
          if (!(d.options.maxTags && d.itemsArray.length >= d.options.maxTags || b !== !1 && !b)) {
              ...
              if (!b.toString().match(/^\s*$/)) {
                  ...
                  if (k) {
                      ...
                      m.after(" "),
                      d.isSelect && !a('option[value="' + escape(h) + '"]', d.$element)[0]) {
      ...
      "remove": function(b, c) {
          ...
          b && (a(".tag", d.$container).filter(function() {
      ...
      "build": function(b) {
          ...
          h.source && a.fn.typeahead && (d(h, "source"),
          e.$input.typeahead({
              "source": function(b, c) {
                  function d(a) {
          ...
          e.$container.on("keydown", "input", a.proxy(function(b) {
              ...
              case 39:
                  ...
                  break;
              default:
                  e.options.freeInput && a.inArray(b.which, e.options.confirmKeys) >= 0 && (e.add(c.val()),
                  c.val(""),
                  b.preventDefault())
              }
          ...
          e.options.itemValue === g.itemValue && ("INPUT" === e.$element[0].tagName ? e.add(e.$element.val()) : a("option", e.$element).each(function() {
