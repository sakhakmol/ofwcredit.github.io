...
(function() {
  ...
  d.unbindEvents = function(a, b) {
    ...
    , D = (d.getMaximumSize = d.getMaximumWidth,
  ...
  g(c.Type.prototype, {
      ...
      "stop": function() {
          return d.cancelAnimFrame.call(a, this.animationFrame),
          this
      },
      "resize": function(a) {
          this.stop();
  ...
  c.Tooltip = c.Element.extend({
      "draw": function() {
          ...
          a.font = F(this.fontSize, this.fontStyle, this.fontFamily),
          this.xAlign = "center",
          this.yAlign = "above";
          var b = 2
          ...
          var f = this.x - c / 2
            , g = this.y - e;
          switch (a.fillStyle = this.fillColor,
          this.yAlign) {
          case "above":
              a.beginPath(),
  ...
  c.RadialScale = c.Element.extend({
      ...
      "setScaleSize": function() {
          ...
          for (this.ctx.font = F(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily),
          ...
          if (this.display) {
              ...
              if (e(this.yLabels, function(b, c) {
                  if (c > 0) {
                      ...
                      if (this.showLabels) {
                          if (a.font = F(this.fontSize, this.fontStyle, this.fontFamily),
              ...
              !this.lineArc) {
                  ...
                  for (var b = this.valuesCount - 1; b >= 0; b--) {
                      ...
                      a.font = F(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily),
