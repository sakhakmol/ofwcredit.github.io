  ...
  if (window.Select2 === b) {
      ...
      F = D(Object, {
          ...
          "positionDropdown": function() {
              ...
              g.css("width", ""),
              u = g.outerWidth(!1) + (f.scrollHeight === f.clientHeight ? 0 : L.width),
              u > j ? j = u : u = j,
              k = g.outerHeight(!1),
              v = o >= r + u) : this.container.removeClass("select2-drop-auto-width"),
              ...
              g.addClass("select2-drop-above")) : (e.top = q,
              e.bottom = "auto",
          ...
          "open": function() {
              ...
              K.on("mousemove.select2Event", function(a) {
                  M.x = a.pageX,
                  M.y = a.pageY
              }),
              !0) : !1
          ...
          "loadMoreIfNeeded": function() {
              ...
              this.opts.query({
                  ...
                  "callback": this.bind(function(a) {
                      ...
                      a.more === !0 ? (c.detach().appendTo(b).text(z(e.opts.formatLoadMore, e.opts.element, d + 1)),
                      ...
                      "callback": this.bind(function(f) {
                          ...
                          if (i == this.queryCount) {
                              ...
                              0 === f.results.length && y(l.formatNoMatches, "formatNoMatches"))
                                  return void e("<li class='select2-no-results'>" + z(l.formatNoMatches, l.element, j.val()) + "</li>");
                              k.empty(),
              ...
              function c() {
                  ...
                  if ("copy" === this.opts.width || "resolve" === this.opts.width) {
                      ...
                      c !== b)
                          ...
                          f = 0,
                          g = d.length; g > f; f += 1)
                              if (h = d[f].replace(/\s/g, ""),
                              e = h.match(/^width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i),
                              null !== e && e.length >= 1)
                                  return e[1];
                      return "resolve" === this.opts.width ? (c = this.opts.element.css("width"),
                      c.indexOf("%") > 0 ? c : 0 === this.opts.element.outerWidth(!1) ? "auto" : this.opts.element.outerWidth(!1) + "px") : null
                  }
      ...
      G = D(F, {
          ...
          "opening": function() {
              ...
              c = this.search.get(0),
              c.createTextRange ? (d = c.createTextRange(),
              d.collapse(!1),
              d.select()) : c.setSelectionRange && (e = this.search.val().length,
          ...
          "initContainer": function() {
              ...
              this.search.on("keydown", this.bind(function(a) {
                  if (this.isInterfaceEnabled() && 229 != a.keyCode) {
                      if (a.which === E.PAGE_UP || a.which === E.PAGE_DOWN)
                          return void p(a);
                      switch (a.which) {
                      case E.UP:
                      case E.DOWN:
              ...
              this.focusser.on("keydown", this.bind(function(a) {
                  if (this.isInterfaceEnabled() && a.which !== E.TAB && !E.isControl(a) && !E.isFunctionKey(a) && a.which !== E.ESC) {
                      if (this.opts.openOnEnter === !1 && a.which === E.ENTER)
                          return void p(a);
                      ...
                      return a.which == E.DELETE || a.which == E.BACKSPACE ? (this.opts.allowClear && this.clear(),
                      void p(a)) : void 0
                  }
              })),
              j(this.focusser),
          ...
          "initSelection": function() {
              if (this.isPlaceholderOptionSelected())
                  ...
                  this.opts.initSelection.call(null, this.opts.element, function(c) {
                      ...
                      a.close(),
                      a.setPlaceholder(),
                      a.nextSearchTerm = a.opts.nextSearchTerm(c, a.search.val()))
                  })
              }
          },
          ...
          "postprocessResults": function(a, b, c) {
              ...
              c !== !1 && this.highlight(b === !0 && d >= 0 ? d : 0),
              b === !0) {
          ...
          "data": function(a) {
              ...
              c == b && (c = null),
              c) : (arguments.length > 1 && (d = arguments[1]),
              void (a ? (c = this.data(),
      ...
      H = D(F, {
              ...
              this.search.on("keydown", this.bind(function(a) {
                  if (this.isInterfaceEnabled()) {
                      ...
                      if (c.length && (a.which == E.LEFT || a.which == E.RIGHT || a.which == E.BACKSPACE || a.which == E.DELETE || a.which == E.ENTER)) {
                          var g = c;
                          return a.which == E.LEFT && d.length ? g = d : a.which == E.RIGHT ? g = e.length ? e : null : a.which === E.BACKSPACE ? this.unselect(c.first()) && (this.search.width(10),
                          g = d.length ? d : e) : a.which == E.DELETE ? this.unselect(c.first()) && (this.search.width(10),
                          g = e.length ? e : null) : a.which == E.ENTER && (g = null),
                          this.selectChoice(g),
                          p(a),
                          void (g && g.length || this.open())
                      }
                      if ((a.which === E.BACKSPACE && 1 == this.keydowns || a.which == E.LEFT) && 0 == f.offset && !f.length)
          ...
          "updateSelection": function(b) {
              var c = []
                ...
                , f = this;
              a(b).each(function() {
                  e(f.id(this), c) < 0 && (c.push(f.id(this)),
                  d.push(this))
              }),
              b = d,
          ...
          "onSelect": function(a, c) {
              ...
              this.resizeSearch(),
              this.getMaximumSelectionSize() > 0 && this.val().length >= this.getMaximumSelectionSize() ? this.updateResults(!0) : this.nextSearchTerm != b && (this.search.val(this.nextSearchTerm),
              this.updateResults(),
              this.search.select()),
          ...
          "buildChangeDetails": function(a, b) {
              for (var b = b.slice(0), a = a.slice(0), c = 0; c < b.length; c++)
                  for (var d = 0; d < a.length; d++)
                      g(this.opts.id(b[c]), this.opts.id(a[d])) && (b.splice(c, 1),
                      c > 0 && c--,
                      a.splice(d, 1),
                      d--);
              return {
          ...
          "data": function(b, c) {
              ...
              this.clearSearch(),
              c && this.triggerChange(this.buildChangeDetails(e, this.data())),
              void 0)
          }
      }),
