...
!function(a) {
  a.widget("ui.chatbox", {
      ...
      "_create": function() {
          ...
          (b.uiChatboxInput = a("<div></div>")).addClass("ui-widget-content ui-chatbox-input").click(function() {}).appendTo(i))
            , k = (b.uiChatboxInputBox = a("<textarea></textarea>")).addClass("ui-widget-content ui-chatbox-input-box ").appendTo(j).keydown(function(c) {
              return c.keyCode && c.keyCode == a.ui.keyCode.ENTER ? (msg = a.trim(a(this).val()),
